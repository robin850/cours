...
Sous Linux, vous avez sans doute Ruby d'installé sur votre machine. Le problème est que assez peu de distributions proposent Ruby dans sa version 1.9.3. Si Ruby est déjà installé, il l'est sûrement dans sa version 1.8.7. Pour connaître la version actuelle de ruby, dans un terminal, tapez :
